...
const routes: RouteRecordRaw[] = [
  { path: '/login', name: 'login', component: getView('Login'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'produccion', name: 'produccion', component: getView('Produccion'), meta: { roles: ALL_ROLES } },
      { path: 'inventario', name: 'inventario', component: getView('Inventario'), meta: { roles: ALL_ROLES } },
      { path: 'insumos', name: 'insumos', component: getView('Inventario'), meta: { roles: ALL_ROLES } },
      { path: 'productos', name: 'productos', component: getView('Productos'), meta: { roles: ALL_ROLES } },
      { path: 'recetas', name: 'recetas', component: getView('Productos'), meta: { roles: ALL_ROLES } },
      { path: 'prendas', name: 'prendas', component: getView('PrendasListas'), meta: { roles: ALL_ROLES } },
      { path: 'clientes', name: 'clientes', component: getView('Clientes'), meta: { roles: ALL_ROLES } },
      { path: 'cotizador', name: 'cotizador', component: getView('Cotizador'), meta: { roles: ALL_ROLES } },
      { path: 'optimizador', name: 'optimizador', component: getView('Optimizador'), meta: { roles: ALL_ROLES } },
