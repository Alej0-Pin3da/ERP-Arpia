...
const tiempoConfeccion = ref<number | null>(null)
const costoInsumos = ref<number | null>(null)
...
watch(() => props.visible, (v) => {
  if (v) {
    ...
    if (props.receta) {
      ...
      tiempoConfeccion.value = props.receta.tiempo_confeccion_min ?? null
      costoInsumos.value = props.receta.costo_insumos ?? null
