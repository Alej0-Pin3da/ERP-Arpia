      ...
      <table class="w-full min-w-[760px] text-xs text-left border-collapse">
        <thead>
          <tr class="border-b border-stone-800 text-stone-400 font-mono">
            ...
            <th class="py-2.5 px-3 min-w-[180px]">Prenda</th>
            <th class="py-2.5 px-3">Cliente</th>
            <th class="py-2.5 px-3 min-w-[180px]">Motivo / Tipo de Ajuste</th>
            <th class="py-2.5 px-3 whitespace-nowrap">Estado</th>
            <th class="py-2.5 px-3 text-center whitespace-nowrap">Acciones</th>
          </tr>
        </thead>
        <tbody class="divide-y divide-stone-800/60 font-mono">
          ...
          <tr v-for="d in devolucionesDisplay" :key="d.id">
            <td class="py-3 px-3 text-amber-400 font-bold sticky left-0 z-10 bg-stone-900/95 whitespace-nowrap">{{ d.codigo }}</td>
            <td class="py-3 px-3 font-serif font-semibold text-stone-200 min-w-[180px]">{{ d.prenda }}</td>
            <td class="py-3 px-3 text-stone-300 whitespace-nowrap">{{ d.cliente }}</td>
            <td class="py-3 px-3 text-stone-400 min-w-[180px]">{{ d.motivo }} ({{ d.tipo }})</td>
