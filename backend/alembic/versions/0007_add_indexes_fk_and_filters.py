...
down_revision: Union[str, None] = '27d5c5b6fd80'
...
def upgrade() -> None:
    ...
    op.create_index('ix_Detalle_Ventas_producto_id', 'Detalle_Ventas', ['producto_id'], unique=False)
    op.create_index('ix_Detalle_Ventas_variante_id', 'Detalle_Ventas', ['variante_id'], unique=False)
    ...
    op.create_index('ix_Items_Devolucion_devolucion_id', 'Items_Devolucion', ['devolucion_id'], unique=False)
    op.create_index('ix_Items_Devolucion_producto_id', 'Items_Devolucion', ['producto_id'], unique=False)
    op.create_index('ix_Items_Devolucion_variante_id', 'Items_Devolucion', ['variante_id'], unique=False)
    ...
    op.create_index('ix_Compras_Insumos_proveedor_id', 'Compras_Insumos', ['proveedor_id'], unique=False)
    op.create_index('ix_Compras_Insumos_fecha_compra', 'Compras_Insumos', ['fecha_compra'], unique=False)

    # Productos, Variantes & BOM
    op.create_index('ix_Productos_tipo_producto_id', 'Productos', ['tipo_producto_id'], unique=False)
    op.create_index('ix_Variantes_Producto_producto_id', 'Variantes_Producto', ['producto_id'], unique=False)
    ...
    op.create_index('ix_BOM_Productos_producto_incluido_id', 'BOM_Productos', ['producto_incluido_id'], unique=False)
